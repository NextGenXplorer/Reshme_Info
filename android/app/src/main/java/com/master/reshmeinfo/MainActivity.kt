...
class MainActivity : ReactActivity() {
  ...
  private fun initializeUnityAds() {
    // Get Game ID from manifest metadata
    val appInfo = packageManager.getApplicationInfo(packageName, android.content.pm.PackageManager.GET_META_DATA)
    val gameId = appInfo.metaData?.getString("com.unity3d.ads.gameId") ?: "YOUR_UNITY_GAME_ID"
    val testMode = appInfo.metaData?.getBoolean("com.unity3d.ads.testMode") ?: true
